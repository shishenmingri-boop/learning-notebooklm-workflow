# NotebookLM Upload Plan - Daily News Digest 2026-06-23
...
```bash
node scripts/notebooklm_web_upload.mjs --output-dir learning-output/2026-06-23-news --notebook-title "Daily News 2026-06-23" --files 00_overview.md,01_bbc.md,02_aljazeera.md,03_sources.md --source-url-file sources.md --browser-channel chrome --user-data-dir .notebooklm-playwright-profile --auto-continue true --close-browser true
```

## Playwrightプロファイル方針（ニュース運用）

- 安定実績のある `.notebooklm-playwright-profile` を使用する。
